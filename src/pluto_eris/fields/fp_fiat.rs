...
let (x32, x33) = x11.carrying_add(x8, x31);
    ...
    let mut x35: u64 = 0;
    let mut x36: u64 = 0;
let (x35, x36) = x20.widening_mul(0x9ffffcd2ffffffff);
    let mut x37: u64 = 0;
    let mut x38: u64 = 0;
let (x37, x38) = x35.widening_mul(0x2400000000002400);
    let mut x39: u64 = 0;
...
let (x61, x62) = x40.carrying_add(x37, x60);
    ...
    let mut x64: u64 = 0;
    let mut x65: u1 = 0;
let (x64, x65) = x20.overflowing_add(x49);
    let mut x66: u64 = 0;
    let mut x67: u1 = 0;
let (x66, x67) = x22.carrying_add(x51, x65);
    let mut x68: u64 = 0;
...
//    addcarryx_u64(&mut x121, &mut x122, x120, (x79 as u64), x106);
 let (x121, x122) = (x79 as u64).carrying_add(x106, x120);
    let mut x123: u64 = 0;
    let mut x124: u64 = 0;
let (x123, x124) = x107.widening_mul(0x9ffffcd2ffffffff);
    let mut x125: u64 = 0;
    let mut x126: u64 = 0;
let (x125, x126) = x123.widening_mul(0x2400000000002400);
    let mut x127: u64 = 0;
...
let (x210, x211) = x168.carrying_add(x195, x209);
    let mut x212: u64 = 0;
    let mut x213: u64 = 0;
let (x212, x213) = x196.widening_mul(0x9ffffcd2ffffffff);
    let mut x214: u64 = 0;
    let mut x215: u64 = 0;
let (x214, x215) = x212.widening_mul(0x2400000000002400);
    let mut x216: u64 = 0;
...
let (x238, x239) = x217.carrying_add(x214, x237);
    ...
    let mut x241: u64 = 0;
    let mut x242: u1 = 0;
let (x241, x242) = x196.overflowing_add(x226);
    let mut x243: u64 = 0;
    let mut x244: u1 = 0;
let (x243, x244) = x198.carrying_add(x228, x242);
    let mut x245: u64 = 0;
...
let (x299, x300) = x257.carrying_add(x284, x298);
    let mut x301: u64 = 0;
    let mut x302: u64 = 0;
let (x301, x302) = x285.widening_mul(0x9ffffcd2ffffffff);
    let mut x303: u64 = 0;
    let mut x304: u64 = 0;
let (x303, x304) = x301.widening_mul(0x2400000000002400);
    let mut x305: u64 = 0;
...
let (x327, x328) = x306.carrying_add(x303, x326);
    ...
    let mut x330: u64 = 0;
    let mut x331: u1 = 0;
let (x330, x331) = x285.overflowing_add(x315);
    let mut x332: u64 = 0;
    let mut x333: u1 = 0;
let (x332, x333) = x287.carrying_add(x317, x331);
    let mut x334: u64 = 0;
...
let (x388, x389) = x346.carrying_add(x373, x387);
    let mut x390: u64 = 0;
    let mut x391: u64 = 0;
let (x390, x391) = x374.widening_mul(0x9ffffcd2ffffffff);
    let mut x392: u64 = 0;
    let mut x393: u64 = 0;
let (x392, x393) = x390.widening_mul(0x2400000000002400);
    let mut x394: u64 = 0;
...
let (x416, x417) = x395.carrying_add(x392, x415);
    ...
    let mut x419: u64 = 0;
    let mut x420: u1 = 0;
let (x419, x420) = x374.overflowing_add(x404);
    let (x419, x420) = x374.overflowing_add(x404);
    let mut x421: u64 = 0;
    let mut x422: u1 = 0;
let (x421, x422) = x376.carrying_add(x406, x420);
...
let (x448, x449) = x5.widening_mul(arg1[0]);
    ...
    let mut x451: u1 = 0;
let (x450, x451) = x449.overflowing_add(x446);
    let (x458, x451) = x449.overflowing_add(x446);
    let mut x452: u64 = 0;
    let mut x453: u1 = 0;
let (x452, x453) = x447.carrying_add(x444, x451);
    let mut x454: u64 = 0;
...
let (x477, x478) = x435.carrying_add(x462, x476);
    let mut x479: u64 = 0;
    let mut x480: u64 = 0;
let (x479, x480) = x463.widening_mul(0x9ffffcd2ffffffff);
    let mut x481: u64 = 0;
    let mut x482: u64 = 0;
let (x481, x482) = x479.widening_mul(0x2400000000002400);
    let mut x483: u64 = 0;
...
let (x505, x506) = x484.carrying_add(x481, x504);
    ...
    let mut x508: u64 = 0;
    let mut x509: u1 = 0;
let (x508, x509) = x463.overflowing_add(x493);
    let (x508, x509) = x463.overflowing_add(x493);
    let mut x510: u64 = 0;
    let mut x511: u1 = 0;
let (x510, x511) = x465.carrying_add(x495, x509);
...
let (x566, x567) = x524.carrying_add(x551, x565);
    let mut x568: u64 = 0;
    let mut x569: u64 = 0;
let (x568, x569) = x552.widening_mul(0x9ffffcd2ffffffff);
    let mut x570: u64 = 0;
    let mut x571: u64 = 0;
let (x570, x571) = x568.widening_mul(0x2400000000002400);
    let mut x572: u64 = 0;
...
let (x594, x595) = x573.carrying_add(x570, x593);
    ...
    let mut x597: u64 = 0;
    let mut x598: u1 = 0;
let (x597, x598) = x552.overflowing_add(x582);
    let (x597, x598) = x552.overflowing_add(x582);
    let mut x599: u64 = 0;
    let mut x600: u1 = 0;
let (x599, x600) = x554.carrying_add(x584, x598);
